...
### file name ###
filename <- paste0('thy_n17_case_method4_', format(MAF, scientific=FALSE), '_asian_', format(asian, scientific=FALSE))
...
### functional region ###
cases_noncoding <- cases_noncoding %>% filter(!is.na(encode_pELS))
...
# indel variant table
cases_noncoding <- indel_finder(cases_noncoding)
