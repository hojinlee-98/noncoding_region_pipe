...
### file name ###
filename <- paste0('thy_n17_case_method7_', format(MAF, scientific=FALSE), '_asian_', format(asian, scientific=FALSE))
...
cases_noncoding <- cases_noncoding %>% filter((jarvis >=0.9) & !(is.na(jarvis))) # snp for PLS and pELS
# snp + indel 
